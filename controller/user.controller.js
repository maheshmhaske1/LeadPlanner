...
exports.createAccount = async (req, res) => {
    ...
    await validator.checkMandatoryFields(res, { first_name, last_name, email, password, phone, address1, city, state, country, postcode })
    await validator.validateEmail(res, email)
